...
/*
다형성(Polymorphism)
: 하나의 인스턴스를 여러 타입의 참조변수를 통해 참조할 때 참조변수의
타입에 따라 다양한 형태의 인스턴스를 이용할 수 있는 특성을 말한다,

-부모타입의 참조변수를 자식인스턴스를 참조
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		homeChild.childMethod();//오버라이딩 한 메서드
		...
		Object클래스에 정의된 모든 메서드를 별도의 선언없이 사용할 수 있고, 필요하다면
		오버라이딩도 할 수 있다. 
		 */
