...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/* 기본자료형의 경우 비교연산자 ==을 통해 값에 대한 비교를 한다. 변수에 값이
		할당되어 있으므로 아래와 같이 비교할 수 있다. */
		int num1=10, num2=20;
		...
		*/
		...
		참조값(주소)에 대한 비교를 하게된다. 2개의 인스턴스는 따로 생성되므로 다르다는
		결과가 출력된다. */
		if(str1==str2) {
		...
		/* equals() 메서드 : Object클래스로부터 상속받은 메서드로 실제 저장된
		 문자열의 내용을 비교하도록 정의되어있다. 즉 아래는 인스턴스에 저장된 실제 문자
		 열에 대한 비교가 이루어진다.
		 */
		if(str1.equals(str2)) {
		...
		: 더블쿼테이션을 사용한다. 이 경우 내용이 동일하다면 같은 주소를 사용한다. 즉 새로운
		메모리를 할당하지 않는다. 따라서 String 인스턴스는 주로 방법2를 통해 생성하는 것이
		좋다.
		 */
		String str3 = "자바개발자";
		String str4 = "자바개발자";
