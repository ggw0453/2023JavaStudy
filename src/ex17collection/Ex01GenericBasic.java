...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 컴파일 에러가 발생하게 되므로 실행자체가 불가능해진다. 
		 즉 자료형에는 안전하지만, 구현에는 불편함이 있다. 
		 다른 인스턴스를 저장하기 위해서는 또 다른 Box 클래스를 생성해야한다.
		 */
		
		/*
		 아래와 같이 Orange가 아닌 인스턴스를 저장하면 즉시 컴파일에러가 발생하여
		 실행할 수 없는 코드가 된다. 즉 자료형에는 안전하다고 할 수 있다.
		 */
		...
		/*
		하자만 오렌지 같은 String을 저장하고, 이를 꺼내서 다운캐스팅 하는 부분에서는
		예외가 발생된다. 즉 런타임 에러가 발생하게되므로 실행전에는 오류를 예측하기 쉽지 않은
		단점이 있다.
		 */
