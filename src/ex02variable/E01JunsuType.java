...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		-일반적으로 CPU(중앙처리장치)는 정수형 연산을 할 떄 int형을 가장 빠르게 처리한다
		-즉 정수형 변수를 사용할 때에는 거의 대부분 int형을 사용하면된다.
		 */
		...
		-CPU는 정수의 연산인경우 int형에 최적화데어 있기 때문이다.
		...
		이때 접미사(L 혹은 l)을 붙여서 int형의 자료가 아닌 long형의 자료임을 컴파일러에게
		알려줘야 한다. 이와같이 할당을 위한 입력되는 숫자도 자료형을 기반으로 메모리에 로드되는데
