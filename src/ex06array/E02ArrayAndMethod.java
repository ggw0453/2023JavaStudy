...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		/* 배열명을 그대로 출력하면 메모리 주소값을 문자형태로 출력하므로
		 @가 포함된 형태가된다. 즉 배열명은 배열에 저장된 값 자체가 아닌 힙영역에
		 생성된 메모리 주소값을 저장하게된다.
		*/
		...
		/*
		 main에서 생성했던 배열객체의 참조값을 매개변수로 넘기고, 다시 반환받았을므로
	...
	/* 매계변수로 전달된 배열의 참조값을 ar로 받게되므로 해당 메서드에서도 동일한
	배열을 참조할 수 있게 된다. 즉 main메서드에서 생성한 배열과 동일한 배열을 
	참조하게된다 */
